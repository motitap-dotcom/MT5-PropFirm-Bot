...
**YOU ARE MANAGING A LIVE TRADING BOT ON A REMOTE VPS.**
**YOU CANNOT SSH TO THE VPS. YOU CANNOT CONNECT DIRECTLY.**
**THE ONLY WAY TO MANAGE THE VPS IS: Push & Listen (edit file -> git push -> GitHub Actions runs on VPS -> git pull to read results).**
**EVERY SINGLE VPS OPERATION MUST GO THROUGH THIS WORKFLOW. NO EXCEPTIONS.**
**RESPOND IN HEBREW (עברית) ALWAYS.**
